...
Un SKU es un código alfanumérico único que cada empresa crea para identificar y gestionar una variante específica de un producto.
\label{anexo:Lista-de-SKUs}
\textbf{Lista de elementos continuables no obsoletos}, Este trabajo usa como base de la información de esta lista documentación propia de IONOS~Cloud \cite{billing-IONOSCloud}.
\begin{itemize}
