...
\begin{enumerate}
    ...
    \item \textbf{Gestión}
          ...
          \begin{enumerate}
              ...
              \item  \textbf{Seguimiento y Control: }Tras la implementación y la finalización del proyecto se realiza un seguimiento de su correcto funcionamiento. Fundamental para satisfacer los requisitos RNF01 y RNF02.
              \item \textbf{Tecnologías y Herramientas: } Son las metodologías y enfoques que se han empleado para la elaboración del proyecto y desarrollan los requisitos RNF05 a RNF09
    ...
    \item \textbf{Iteraciones}
          ...
          \begin{enumerate}
              \item \textbf{Iteración 1:} Siendo esta la primera iteración, es en la que se crea la base en la que se basarán el resto de iteraciones, por lo que se deben tomar sus decisiones teniendo en cuenta que podrían afectar al resto del proceso. En esta primera iteración se detectarán los elementos que forman un contrato.
                    ...
                    \begin{enumerate}
                        \item \textbf{Detección de items continuables:} La funcionalidad añadida en esta primera iteración consiste en detectar qué SKUs forman parte de la lista creada. Como el contrato será creado por nosotros, se añadirán todos los SKUs, así que todos deberán estar; cualquiera que falte constituirá un falso positivo. Esto representa el primer paso para cumplir el requisito RF04.02.
                        \item \textbf{Creación de contrato completo:} De manera manual se crea un contrato con todos los SKUs de la lista, cumpliendo así los requisitos RF01.01, RF02.01, RF02.01.01, RF02.01.02 y RF02.03.
                        \item \textbf{Configuración de Credenciales:} Este paso se repite en todas las iteraciones, por lo que no se explicará en las siguientes. Consiste en la configuración concreta de CouchDB para el correcto funcionamiento, cumpliendo así el requisito RF02.02 y sentando las bases para el requisito RF04.03, ya que aquí se definen también los márgenes de tolerancia.
                        \item \textbf{Testeo de funcionamiento: } De manera similar al anterior, este paso se repite en todas las iteraciones, por lo que solo se detalla aquí. En este apartado se diseñan las comprobaciones del correcto funcionamiento de la iteración actual y las previas, resultando clave para satisfacer el requisito RNF01. 
                        \item \textbf{Configuración de alertas y rutinas: } Este apartado comparte la misma característica que los dos anteriores, por lo que se describe únicamente aquí. Consiste en definir las alertas que se enviarán en caso de fallo según la información disponible ---en este caso, los SKUs ausentes--- y en establecer el disparador para su ejecución programada. De este modo se satisfacen los requisitos RF04.01, RF05.01 y RF05.02.

                    \end{enumerate}


              \item \textbf{Iteración 2:} En esta iteración se implementa la medición del uso de los SKUs continuables detectados previamente y su comparación con los valores esperados.
                    \setcounter{enumiii}{0} % Reiniciar contador del tercer nivel si es necesario
                    \begin{enumerate}
                        ...
                        \item \textbf{Comprobación de que contrato completo:} Se verifica que no sea necesario añadir elementos nuevos al contrato; en caso afirmativo, se incorporan. Este paso, común a las demás iteraciones, no se volverá a detallar.
                    \end{enumerate}
              ...
              \item \textbf{Iteración 3:} En esta iteración sabiendo el uso de los diferentes elementos se calcula su gasto económico teórico y se comprueba con el real.
                    \setcounter{enumiii}{0} % Reiniciar contador del tercer nivel si es necesario
                    \begin{enumerate}
                        \item \textbf{Comprobación gasto items continuables: } Conocido el gasto, se calcula el precio de cada elemento y se contrasta con el proporcionado por la API. Este paso resulta fundamental para satisfacer los requisitos RF03.01, RF03.02 y RF03.04, cuya ejecución también está vinculada al requisito RF04.02.
                    \end{enumerate}
              ...
              \item \textbf{Iteración 4:} En esta iteración se pasa a los items no continuables, por lo que se estudia cómo hacer un gasto relativamente constante de estos.
                    \setcounter{enumiii}{0} % Reiniciar contador del tercer nivel si es necesario
                    \begin{enumerate}
                        \item \textbf{Comprobación de endpoint /usage items no continuables: } Se verifica el gasto de items no continuables mediante su SKU.
                        \item \textbf{Creación de gasto de tokens automático:} Se analiza cómo conseguir un consumo de tokens lo más constante posible, atendiendo así a los requisitos RF03.01, RF03.02 y RF03.04, cuya ejecución también está relacionada con el requisito RF03.03. 
                    \end{enumerate}
              ...
              \item \textbf{Iteración 5:} Teniendo ya el gasto, se calcula su precio y se comprueba con el gasto proporcionado por la API.
                    \setcounter{enumiii}{0} % Reiniciar contador del tercer nivel si es necesario
                    \begin{enumerate}
                        \item \textbf{Comprobación gasto items no continuables:} Se verifica el gasto económico de items no continuables mediante su SKU, contrastándolo con el valor obtenido de la API.
                    \end{enumerate}
          \end{enumerate}
\end{enumerate}
\newpage
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        \multirow{3}{*}{Análisis}            & Lista requisitos funcionales                     & 6h     & \multirow{3}{*}{18h}  \\
        \cline{2-3}
                                             & Análisis de requisitos Funcionales               & 6h     &                       \\
        \cline{2-3}
                                             & Análisis de requisitos no Funcionales            & 6h     &                       \\
        \hline
        \multirow{5}{*}{Gestión}             & Planificación                                    & 38h    & \multirow{5}{*}{136h} \\
        \cline{2-3}
        Cronograma de tareas                 & Seguimiento y control                            & 12h    &                       \\
        \cline{2-3}
        ...
        \hline
        \multirow{5}{*}{Iteración 2}         & Comprobación de /usage items continuables        & 16h    & \multirow{5}{*}{24h}  \\
        \cline{2-3}
        ...
        \cline{2-3}
                                             & Testeo de funcionamiento                         & 4h     &                       \\
        \hline
        \multirow{5}{*}{Iteración 5}         & Comprobación gasto items no continuables         & 12h    & \multirow{5}{*}{21h}  \\
        \cline{2-3}
                                             & Comprobación de que contrato completo            & 1h     &                       \\
        \cline{2-3}
                                             & Configuración de credenciales, alertas y rutinas & 2h     &                       \\
...
\section{Cronograma e hitos}\label{sec:hitos}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|c|l|c|c|c|c|c|c|c|c|c|c|}
        \hline
        \multicolumn{12}{|c|}{\textbf{Cronograma de tareas II}}                                                                                                                                                                                                                                                                                   \\
        \hline
        \multicolumn{2}{|c|}{\multirow{2}{*}{\textbf{Paquete de trabajo}}}
                               & \multicolumn{4}{|c|}{\textbf{Mayo}}
                               & \multicolumn{4}{|c|}{\textbf{Junio}}
                               & \multicolumn{2}{|c|}{\textbf{Julio}}                                                                                                                                                                                                                                                                             \\
        \cline{3-12}
        \multicolumn{2}{|c|}{} & S13                                      & S14                   & S15                                        & S16                   & S17                   & S18                   & S19                   & S20                   & S21                   & S22                \\
        \hline
        ...
        \hline
        TFG 2.5                & Defensa                                  &                       &                                            &                       &                       &                       &                       &                       & \cellcolor{ganttblue} & \cellcolor{ganttblue} & \hspace{0pt} \\
        \hline
        TFG 3.x.4              & Testeo funcionamiento                    & \cellcolor{ganttblue} & \cellcolor{ganttblue}                      & \cellcolor{ganttblue} &                       &                       &                       &                       &                       &                       & \hspace{0pt} \\
        \hline
        TFG 3.x.5              & Configuración de alertas y rutinas       & \cellcolor{ganttblue} & \cellcolor{ganttblue}                      &                       &                       &                       &                       &                       &                       &                       & \hspace{0pt} \\
        \hline
...
Sabiendo ya el cronograma se pueden marcar la fecha de finalización de los distintos hitos. \footnote{Como varias partes del TFG son comunes, en vez de referime por ejemplo a TFG 3.1.5, [...], TFG 3.5.5 por separado, en akgunas partes me refiero directamente a 3.x.5 para englobarlos a todos. }
...
\section{Plan de contingencias y riesgos}\label{sec:plan-contingencias}
...
\begin{table}[h!]
    \centering
    \small
    \begin{tabular}{|p{1.5cm}|p{2.5cm}|p{1.5cm}|p{1.5cm}|p{3.8cm}|p{1.8cm}|}
        \hline
        \multicolumn{6}{|c|}{\textbf{Plan de contingencias y riesgos}}                                                                                                                                                                                                                                                                                                                                                                                                                                   \\
        \hline
        \textbf{Origen} & \textbf{Riesgo}                                                                                                                                                              & \textbf{Prob.} & \textbf{Impacto} & \textbf{Solución}                                                                                                                                                                                                          & \textbf{Tipo de medida} \\
        \hline
...
\subsection{Fecha de finalización de la Planificación}
