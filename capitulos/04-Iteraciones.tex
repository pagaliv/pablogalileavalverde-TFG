...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        \hline
        \textbf{Tarea} & \textbf{Horas Estimadas} & \textbf{Horas Reales} & \textbf{Desviación}\\ 
        \hline
        ...
        Reuniones y revisión con el cliente & 5h & 5h & 0\% \\
        Configuración de alertas y rutinas & 4h & 2h & -50\% \\
        \hline
        \textbf{Total} & \textbf{65h} & \textbf{68h} & \textbf{+4.6\%} \\
        \hline
    \end{tabular}
