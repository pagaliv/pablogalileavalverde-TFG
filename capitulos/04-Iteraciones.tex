...
\end{lstlisting}
    \item Clasifica los resultados en \texttt{available} (encontrados) y \texttt{missing} (no encontrados) y después los muestra graficamente con \textit{checks} y \textit{crosses} como se ve en la figura 4.1.
          \begin{figure}[h!]
              \centering
