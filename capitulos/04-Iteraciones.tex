...
El primer problema encontrado fue lograr vincular los recursos a sus SKUs, ya que el nombre de algunos SKUs no es intuitivo; para ello se empezó a usar la API interna de IONOS Cloud \cite{billing-IONOSCloud}.
...
en este contexto \textit{"https://api.ionos.com/billing/{contract}/products"}\cite{billing-IONOSCloud}, sirviendo esta llamada para obtener la información de los productos que hay en el contrato.
