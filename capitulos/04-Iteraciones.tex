...
\begin{itemize}
    ...
    \item \textbf{Programación de tareas (scheduler):} Define ejecuciones automáticas periódicas; esto se desarrollará en mayor profundidad cuando se hable de ello en concreto.
