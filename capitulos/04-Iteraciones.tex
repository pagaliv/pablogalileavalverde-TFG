...
de IONOS Cloud y para persistir se guardará en GitLab de manera habitual y, además, por seguridad se guardará periódicamente tanto en GitHub como en un disco duro físico, como se explicó en la sección \hyperref[sec:plan-contingencias]{Plan de contingencias y riesgos}.
...
} de IONOS Cloud, para que de ese modo, tras la finalización del proyecto, todo el equipo pueda seguir con su mantenimiento. Debido a esto, se sigue además la
estructura de proyectos propia de este equipo. La única peculiaridad fue el uso de la VPN debido a que el GitLab que se usa es el del equipo, siendo estos alemanes.
...
\begin{itemize}
    ...
    \item \textbf{Redundancia geográfica:} Los datos se replican en centros de datos de diferentes
          ubicaciones, protegiendo frente a desastres regionales. Previniendo uno de los posibles riesgos estudiados en el plan de riesgos.
\end{itemize}
...
Lo único que hay que tener en cuenta es el uso de las credenciales, debido a que las credenciales para entrar a CouchDB
...
contratos de facturación. Por lo que, antes de centrarnos en conceptos técnicos, se explicará la estructura general actual del proyecto,
centrándose en estructura y tecnologías.
...
El desarrollo de esta función se explicará por partes.
