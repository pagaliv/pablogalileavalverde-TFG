...
\section{Requisitos}
A partir del análisis anterior, realizado el 4 de febrero, se identificaron los siguientes requisitos, cumpliendo así con las fechas de los hitos que se muestran en la sección~\ref{sec:hitos}.
\begin{table}[htbp]
    \centering
