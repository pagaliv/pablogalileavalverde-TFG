...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{0.1\textwidth}|p{0.7\textwidth}|}
        ...
        \hline
        RNF05  & Uso de JavaScript ES6+ con módulos por herencia del grupo de trabajo.                        \\
        \hline
        RNF06  & Uso de Node.js 18+.                                                                          \\
        \hline
        RNF07  & Gestionar los paquetes con Yarn 3+.                                                          \\
        \hline
        RNF08  & Usar Gitlab como control de versiones principal.                                             \\
        \hline
        RNF09  & Usar la estructura de proyecto propia del equipo de trabajo.                                 \\
        \hline
    \end{tabular}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{0.1\textwidth}|p{0.55\textwidth}|}
        ...
        \hline
        RF02.01.01 & Provisión automática de Máquinas Virtuales (VMs).                                                                                                                                    \\
        \hline
