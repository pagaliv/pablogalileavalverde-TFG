...
\begin{enumerate}
    ...
    \item \textbf{Bases de datos: } Conjunto de datos organizado de tal modo que permita obtener con rapidez diversos tipos de información. Existen tanto relacionales como no relacionales; para más información, consultar el Anexo 1.
...
\begin{itemize}
    ...
    \item \textbf{Mejora continua}: Permite iteraciones rápidas y seguras. Es muy fácil de separar en módulos.
\end{itemize}
